...
import IntroTxt from "./components/txt";
        ...
        <div className="col-md-12">
          <div className="Weather-main">
            ...
            <div class="col-sm-3 mt-3  ">
              <input type="text" class="form-control bg-transparent" onChange={HandlePlaceInput} value={PlaceName} placeholder="Place" aria-label="Place" required></input>
            </div>
            <button type="button" class="btn btn-outline-light mt-3  " onClick={Searchplace}>Submit</button>
          </div>
